...
pub static NATIVE_PLUGIN_REGISTRY: &[(&str, NativePluginFactory)] = &[
    ...
    #[cfg(feature = "native-andamento-controller")]
    ("andamento-controller", andamento_controller::create_plugin),
    #[cfg(feature = "native-andamento-rail")]
    ("andamento-rail", andamento_rail::create_plugin),
    #[cfg(feature = "native-andamento-config")]
    ("andamento-config", andamento_config::create_plugin),
];
