...
#[derive(Clone, PartialEq, ::prost::Oneof)]
    pub enum Payload {
        ...
        ResizePaneWithIdToPayload(super::ResizePaneWithIdToPayload),
    }
}
#[allow(clippy::derive_partial_eq_without_eq)]
#[derive(Clone, PartialEq, ::prost::Message)]
...
#[allow(clippy::derive_partial_eq_without_eq)]
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct ResizePaneWithIdToPayload {
    #[prost(message, optional, tag="1")]
    pub pane_id: ::core::option::Option<PaneId>,
    #[prost(message, optional, tag="2")]
    pub direction: ::core::option::Option<super::resize::MoveDirection>,
    #[prost(message, optional, tag="3")]
    pub size: ::core::option::Option<super::event::PaneDimensionConstraint>,
}
#[allow(clippy::derive_partial_eq_without_eq)]
#[derive(Clone, PartialEq, ::prost::Message)]
...
impl CommandName {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            ...
            CommandName::ResizePaneWithIdTo => "ResizePaneWithIdTo",
        }
    }
    ...
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
        match value {
            ...
            "ResizePaneWithIdTo" => Some(Self::ResizePaneWithIdTo),
            _ => None,
        }
    }
}
